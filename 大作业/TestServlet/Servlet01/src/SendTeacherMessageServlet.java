...
public class SendTeacherMessageServlet extends HttpServlet {

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        int senderId = (Integer) request.getSession().getAttribute("parentId");  // 获取当前登录的用户ID (家长)
        int receiverId = Integer.parseInt(request.getParameter("receiverId"));  // 获取接收方的ID (老师)
